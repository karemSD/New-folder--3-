...
class ManagerModel with TopModel {
  ...
  set setCreatedAt(DateTime createdAtParameter) {
    ...
    if (createdAtParameter.isBefore(now)) {
      exception = Exception("manager creating time cannot be in the past");
      throw exception;
    }
    //لا يمكن أن يكون وقت إنشاء دوكيومنت الخاص بالمدير بعد الوقت الحالي

    if (createdAtParameter.isAfter(now)) {
      exception = Exception("manager creating time cannot be in the future");
      throw exception;
    }
  ...
  set setId(String idParameter) {
    ...
    if (idParameter.isEmpty) {
      exception = Exception("manager id cannot be empty");
      throw exception;
    }
  ...
  set setUpdatedAt(DateTime updatedAtParameter) {
    ...
    if (updatedAtParameter.isBefore(createdAt)) {
      exception = Exception("updated time cannot be before creating time");
      throw exception;
    }
    updatedAt = updatedAtParameter;
  }
