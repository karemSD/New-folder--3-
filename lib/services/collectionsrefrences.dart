...
typedef PartialWithFieldValue<T> = Map<String, dynamic> Function(T instance);

List<CollectionReference> listtt = [
  usersRef,
  userTaskCategoryRef,
];
...
final CollectionReference watingMamberRef =
    fireStore.collection("wating_members").withConverter<WaitingMemberModel>(
          fromFirestore: (snapshot, options) =>
